...
if(! class_exists('Youtube_recommendations_admin')){

    class Youtube_recommendations_admin {
        ...
        public function __construct($basename, $slug, $json_filename, $version){
            ...
            $this->plugin_filename  = $json_filename;
            $this->plugin_version   = $version;

            add_action('admin_menu', array($this, 'add_plugin_page'));
            add_action('admin_init', array($this, 'page_init'));
            add_action('admin_footer_text', array($this, 'page_footer'));
            add_action('admin_notices', array($this, 'show_notices')); //notificações
            add_action('plugin_action_links_' . $this->plugin_basename , array($this, 'add_settings_link')); //link para tela de configuração
        ...
        public function create_admin_page() { ?>
            <div class="wrap">
                ...
                <?php
                    settings_fields( 'my_yt_rec_options' ); // mp,e das options dentro do bd
